    ...
    <jsp:body>
        ...
        <form method="post" action ="/generateCard">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputQuery" placeholder="Chiens, chats" name="query">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control text-capitalize" id="formControlSelectLang" name="selectLang">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control text-capitalize" id="formControlSelectCategory" name="selectCategory">
